...
public static final String URL_ADD="http://192.168.217.1/modul6mobile/insert.php";
public static final String URL_GET_ALL = "http://192.168.217.1/modul6mobile/read.php";
public static final String URL_GET_MHS = "http://192.168.217.1/modul6mobile/select.php?id=";
public static final String URL_UPDATE_MHS = "http://192.168.217.1/modul6mobile/update.php";
public static final String URL_DELETE_MHS = "http://192.168.217.1/modul6mobile/delete.php?id=";
